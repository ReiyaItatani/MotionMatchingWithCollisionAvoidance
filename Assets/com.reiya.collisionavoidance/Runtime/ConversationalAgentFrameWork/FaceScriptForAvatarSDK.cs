...
public class FaceScriptForAvatarSDK : MonoBehaviour {
...
private static readonly int blink_left = 0; // Blink_Left
private static readonly int blink_right = 1;  // Blink_Right
private static readonly int browsDown_left = 2;  // BrowsDown_Left
private static readonly int browsDown_right = 3; // BrowsDown_Right
private static readonly int browsIn_left = 4; // BrowsIn_Left
private static readonly int browsIn_right = 5; // BrowsIn_Right
private static readonly int browsOuterLower_left = 6; // BrowsOuterLower_Left
private static readonly int browsOuterLower_right = 7; // BrowsOuterLower_Right
private static readonly int browsUp_left = 8; // BrowsUp_Left
private static readonly int browsUp_right = 9; // BrowsUp_Right
private static readonly int cheekPuff_left = 10; // CheekPuff_Left
private static readonly int cheekPuff_right = 11; // CheekPuff_Right
private static readonly int eyesWide_left = 12; // EyesWide_Left
private static readonly int eyesWide_right = 13; // EyesWide_Right
private static readonly int frown_left = 14; // Frown_Left
private static readonly int frown_right = 15; // Frown_Right
private static readonly int jawBackward = 16; // JawBackward
private static readonly int jawForeward = 17; // JawForeward
private static readonly int jawRotateY_left = 18; // JawRotateY_Left
private static readonly int jawRotateY_right = 19; // JawRotateY_Right
private static readonly int jawRotateZ_left = 20; // JawRotateZ_Left
private static readonly int jawRotateZ_right = 21; // JawRotateZ_Right
private static readonly int jawDown = 22; // Jaw_Down
private static readonly int jawLeft = 23; // Jaw_Left
private static readonly int jawRight = 24; // Jaw_Right
private static readonly int jawUp = 25; // Jaw_Up
private static readonly int lowerLipDown_left = 26; // LowerLipDown_Left
private static readonly int lowerLipDown_right = 27; // LowerLipDown_Right
private static readonly int lowerLipIn = 28; // LowerLipIn
private static readonly int lowerLipOut = 29; // LowerLipOut
private static readonly int midmouth_left = 30; // Midmouth_Left
private static readonly int midmouth_right = 31; // Midmouth_Right
private static readonly int mouthDown = 32; // MouthDown
private static readonly int mouthNarrow_left = 33; // MouthNarrow_Left
private static readonly int mouthNarrow_right = 34; // MouthNarrow_Right
private static readonly int mouthOpen = 35; // MouthOpen
private static readonly int mouthUp = 36; // MouthUp
private static readonly int mouthWhistle_left = 37; // MouthWhistle_NarrowAdjust_Left
private static readonly int mouthWhistle_right = 38; // MouthWhistle_NarrowAdjust_Right
private static readonly int noseScrunch_left = 39; // NoseScrunch_Left
private static readonly int noseScrunch_right = 40; // NoseScrunch_Right
private static readonly int smileLeft = 41; // Smile_Left
private static readonly int smileRight = 42; // Smile_Right
private static readonly int squint_left = 43; // Squint_Left
private static readonly int squint_right = 44; // Squint_Right
private static readonly int toungeUp = 45; // TongueUp
private static readonly int upperLipIn = 46; // UpperLipIn
private static readonly int upperLipOut = 47; // UpperLipOut
private static readonly int upperLipUp_left = 48; // UpperLipUp_Left
private static readonly int upperLipUp_right = 49; // UpperLipUp_Right
