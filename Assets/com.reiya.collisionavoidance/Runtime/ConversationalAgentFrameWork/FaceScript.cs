...
public class FaceScript : MonoBehaviour {
    ...
    private static readonly int blink_left = 23; //23
    private static readonly int blink_right = 24;  //24
    private static readonly int browsDown_left = 15;  //15
    private static readonly int browsDown_right = 16; //16
    // private static readonly int browsIn_left = 4; //non
    // private static readonly int browsIn_right = 5; //non
    // private static readonly int browsOuterLower_left = 6; //17(Both Brows)
    // private static readonly int browsOuterLower_right = 7; //17(Both Brows)
    private static readonly int browsOuterLower = 17; //17(Both Brows)
    private static readonly int browsUp_left = 68; //68
    private static readonly int browsUp_right = 70; //70
    private static readonly int cheekPuff_left = 132; //132
    private static readonly int cheekPuff_right = 133; //133
    private static readonly int eyesWide_left = 142; //142
    private static readonly int eyesWide_right = 149; //149
    private static readonly int frown_left = 44; //44
    private static readonly int frown_right = 45; //45
    private static readonly int jawBackward = 117; //117
    private static readonly int jawForeward = 37; //37
    private static readonly int jawRotateY_left = 38; //38
    private static readonly int jawRotateY_right = 40; //40
    // private static readonly int jawRotateZ_left = 20; //non
    // private static readonly int jawRotateZ_right = 21; //non
    private static readonly int jawDown = 39; //39
    private static readonly int jawLeft = 38; //38
    private static readonly int jawRight = 40; //40
    // private static readonly int jawUp = 25; //non
    private static readonly int lowerLipDown_left = 48; //48
    private static readonly int lowerLipDown_right = 49; //49
    private static readonly int lowerLipIn = 157; //157
    private static readonly int lowerLipOut = 160; //160
    private static readonly int midmouth_left = 47; //47
    private static readonly int midmouth_right = 53; //53
    private static readonly int mouthDown = 154; //154
    // private static readonly int mouthNarrow_left = 33; //46(both)
    // private static readonly int mouthNarrow_right = 34;//46(both)
    private static readonly int mouthNarrow = 46;
    private static readonly int mouthOpen = 39; //39
    // private static readonly int mouthUp = 36; //non
    private static readonly int mouthWhistle_left = 62; //62
    private static readonly int mouthWhistle_right = 63; //63
    private static readonly int noseScrunch_left = 64; //64
    private static readonly int noseScrunch_right = 65; //65
    private static readonly int smileLeft = 58; //58
    private static readonly int smileRight = 59; //59
    private static readonly int squint_left = 33; //33
    private static readonly int squint_right = 34; //34
    private static readonly int toungeUp = 129; //129
    private static readonly int upperLipIn = 167; //167
    private static readonly int upperLipOut = 169; //169
    private static readonly int upperLipUp_left = 171; //171
    private static readonly int upperLipUp_right = 172; //172
