...
namespace CollisionAvoidance
{
    public class AnimationModifier : MonoBehaviour
    {
        ...
        private void SetupIKTargets(Transform headBone)
        {
            ...
            Vector3 rightEarPosition = headBone.position + headBone.right * 0.2f + headBone.forward * 0.3f - headBone.up * 0.1f;
            Vector3 leftEarPosition = headBone.position - headBone.right * 0.2f + headBone.forward * 0.3f- headBone.up * 0.1f;
        ...
        void OnAnimatorIK(int layerIndex)
        {
            if(animator){
                ...
                UpdateIKWeight(AvatarIKGoal.RightHand, rightHand, rightHandTarget.transform, ref rightHandIKWeight);
                UpdateIKWeight(AvatarIKGoal.LeftHand, leftHand, leftHandTarget.transform, ref leftHandIKWeight);
            }
        }

        private void UpdateIKWeight(AvatarIKGoal hand, Transform handTransform, Transform target, ref float weight)
        {
