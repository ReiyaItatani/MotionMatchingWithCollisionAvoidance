...
- **Field of View (FOV)**: The size of the FOV adapts according to the agent's upper body animation, which is crucial for the Collision Avoidance Logic. See [Field of View Adjustments[Kremer et al., 2021]](#field-of-view-adjustments) for how the FOV changes with different animations.
